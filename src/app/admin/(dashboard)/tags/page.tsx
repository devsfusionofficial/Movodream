  ...
  return (
    <div className="mx-auto max-w-[1440px] space-y-4">
      <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
        <div>
          <p className="mb-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-[#d71789]">Taxonomy & labels</p>
          <h1 className="text-3xl font-semibold tracking-[-0.06em] text-[#21182a] sm:text-4xl">Tags</h1>
          <p className="mt-3 text-sm text-[#887f8e]">Fine-tune content discovery with flexible topic tags.</p>
        </div>
        <Button
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border border-[#ebe6ee] bg-white p-5 shadow-[0_5px_18px_rgba(34,20,40,0.025)]">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] font-semibold uppercase tracking-[0.16em] text-[#a49aa9]">Collection</span>
          </div>
          <p className="mt-5 text-2xl font-semibold tracking-[-0.05em] text-[#2b2032]">{tags.length}</p>
          <p className="mt-1 text-xs text-[#857c8b]">Active tags</p>
        </div>
        <div className="rounded-2xl border border-[#ebe6ee] bg-[linear-gradient(115deg,#241235,#4c194e)] p-5 text-white shadow-[0_8px_20px_rgba(36,18,53,0.12)]">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] font-semibold uppercase tracking-[0.16em] text-white/45">Granular search</span>
          </div>
          <p className="mt-5 text-sm font-semibold">Connect related stories.</p>
          <p className="mt-1 max-w-sm text-xs leading-5 text-white/55">
            Tags make cross-category discovery seamless for readers exploring specific themes.
          </p>
        </div>
      </div>
      ...
      <section className="overflow-hidden rounded-2xl border border-[#ebe6ee] bg-white p-4 sm:p-4.5 shadow-[0_5px_18px_rgba(34,20,40,0.025)]">
        <DataTable
          title="Tag index"
          description="Manage tags attached to your posts."
          searchColumnId="name"
