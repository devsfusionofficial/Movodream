      ...
      <Dialog open={viewOpen} onOpenChange={setViewOpen}>
        <DialogContent className="w-full max-w-[calc(100vw-2rem)] sm:max-w-md max-h-[90vh] overflow-y-auto rounded-2xl border border-[#ebe6ee] bg-white p-5 sm:p-6 shadow-2xl min-w-0">
          ...
          <div className="space-y-4 py-3 min-w-0">
            <div className="rounded-xl border border-[#ebe6ee] bg-[#faf8fb] p-4 text-xs leading-relaxed text-[#382b40] break-words [overflow-wrap:anywhere] min-w-0">
              <p className="mb-1 font-bold uppercase tracking-wider text-[#857c8b]">Tag Information</p>
              Tag label: <strong className="text-[#21182a] break-words">#{name}</strong>
            </div>
          </div>
