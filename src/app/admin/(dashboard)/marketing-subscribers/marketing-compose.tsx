              ...
              <div className="overflow-hidden rounded-xl border border-[#ebe6ee] bg-white shadow-xs">
                ...
                <div className="bg-[#21182a] p-5 text-center text-white">
                  ...
                  <div className="mb-3 flex items-center justify-center gap-2.5">
                    ...
                    {/* Instagram */}
                    <a href="https://instagram.com/movodream" target="_blank" rel="noreferrer" title="Instagram" className="flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-white transition-colors hover:bg-[#ff7294] hover:text-white">
                    ...
                    {/* LinkedIn */}
                    <a href="https://linkedin.com/company/movodream" target="_blank" rel="noreferrer" title="LinkedIn" className="flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-white transition-colors hover:bg-[#ff7294] hover:text-white">
