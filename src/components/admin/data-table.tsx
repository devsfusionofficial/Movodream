...
/**
 * Generic list-view primitive every admin resource screen builds on:
 * sorting, column filtering, pagination. Resource-specific screens only
 * define columns + fetch data — this component is the same everywhere.
 */
